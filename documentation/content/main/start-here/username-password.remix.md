...
The [Astro example project](https://github.com/pilcrowOnPaper/lucia/tree/main/examples/remix) in the repo expands on this guide.
...
Define an `action()` for handle sign outs.
