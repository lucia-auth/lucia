...
You can get started immediately by cloning the [Express example](https://github.com/lucia-auth/lucia/tree/main/examples/express/username-and-password) from the repository.

```
npx degit lucia-auth/lucia/examples/express/username-and-password <directory_name>
```

Alternatively, you can [open it in StackBlitz](https://stackblitz.com/github/lucia-auth/lucia/tree/main/examples/express/username-and-password).
