declare global {
  const __buildAssetsURL: typeof import('E:/lucia/node_modules/.pnpm/nuxt@3.6.5_fl4khuxltvm6fadgpmkxkyqtiu/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('E:/lucia/node_modules/.pnpm/nuxt@3.6.5_fl4khuxltvm6fadgpmkxkyqtiu/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const auth: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/lucia')['auth']
  ...
  const db: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/db')['db']
  const defaultContentType: typeof import('h3')['defaultContentType']
  const defineAppConfig: typeof import('E:/lucia/node_modules/.pnpm/nuxt@3.6.5_fl4khuxltvm6fadgpmkxkyqtiu/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  ...
  const generateEmailVerificationToken: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/token')['generateEmailVerificationToken']
  const generatePasswordResetToken: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/token')['generatePasswordResetToken']
  ...
  const isValidEmail: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/email')['isValidEmail']
  const isValidPasswordResetToken: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/token')['isValidPasswordResetToken']
  ...
  const sendEmailVerificationLink: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/email')['sendEmailVerificationLink']
  const sendError: typeof import('h3')['sendError']
  const sendNoContent: typeof import('h3')['sendNoContent']
  const sendPasswordResetLink: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/email')['sendPasswordResetLink']
  ...
  const sqliteDatabase: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/db')['sqliteDatabase']
  ...
  const validateEmailVerificationToken: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/token')['validateEmailVerificationToken']
  const validatePasswordResetToken: typeof import('E:/lucia/examples/nuxt/email-and-password/server/utils/token')['validatePasswordResetToken']
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '../../../../../node_modules/.pnpm/nuxt@3.6.5_fl4khuxltvm6fadgpmkxkyqtiu/node_modules/nuxt/dist/core/runtime/nitro/paths';
export { defineAppConfig } from '../../../../../node_modules/.pnpm/nuxt@3.6.5_fl4khuxltvm6fadgpmkxkyqtiu/node_modules/nuxt/dist/core/runtime/nitro/config';
export { sqliteDatabase, db } from '../../server/utils/db';
export { sendEmailVerificationLink, sendPasswordResetLink, isValidEmail } from '../../server/utils/email';
export { generateEmailVerificationToken, validateEmailVerificationToken, generatePasswordResetToken, validatePasswordResetToken, isValidPasswordResetToken } from '../../server/utils/token';
