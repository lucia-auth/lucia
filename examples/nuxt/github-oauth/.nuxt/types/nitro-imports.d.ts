declare global {
  ...
  const auth: typeof import('E:/lucia/examples/nuxt/github-oauth/server/utils/lucia')['auth']
  ...
  const githubAuth: typeof import('E:/lucia/examples/nuxt/github-oauth/server/utils/lucia')['githubAuth']
...
export { auth, githubAuth } from '../../server/utils/lucia';