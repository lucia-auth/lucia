/*
code directly from https://github.com/jshttp/cookie
...
export const parse = (str: string, options?: CookieParseOptions) => {
...
export const serialize = (name: string, val: string, options?: CookieSerializeOptions) => {
	const opt = options || {};
